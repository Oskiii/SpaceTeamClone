			...
			MainThreadManager.Run(() =>
			{
				switch (identity)
				{
					case ChatManagerNetworkObject.IDENTITY:
						...
						break;
					case CommandNetworkObject.IDENTITY:
						availableCallback = true;
						obj = new CommandNetworkObject(networker, id, frame);
						break;
					case CommandsNetworkObject.IDENTITY:
						availableCallback = true;
						obj = new CommandsNetworkObject(networker, id, frame);
						break;
